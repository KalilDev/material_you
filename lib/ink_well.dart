...
abstract class InteractiveInkFeature extends InkFeature {
  ...
  /// "left" and "right".
  ///
  /// For examples on how the function is used, see [MaterialYouInkSplash] and [InkRipple].
  @protected
  void paintInkCircle({
...
/// See also:
///
///  * [MaterialYouInkSplash.splashFactory]
...
class InkResponse extends StatelessWidget {
  ...
  ///  * [splashColor], the color of the splash.
  ///  * [highlightColor], the color of the highlight.
  ///  * [MaterialYouInkSplash.splashFactory], which defines the default splash.
...
class _InkResponseState extends State<_InkResponseStateWidget>
  ...
  InteractiveInkFeature _createInkFeature(Offset globalPosition) {
    ...
    splash =
        (widget.splashFactory ?? MaterialYouInkSplash.splashFactory).create(
